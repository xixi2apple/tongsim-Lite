...
TONGSIMGAMEPLAY_API DECLARE_LOG_CATEGORY_EXTERN(LogGameplayMessageSubsystem, Log, All);
...
struct TONGSIMGAMEPLAY_API FGameplayMessageListenerHandle
{
public:
	GENERATED_BODY()
 ...
 */
UCLASS()
class TONGSIMGAMEPLAY_API UGameplayMessageSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
